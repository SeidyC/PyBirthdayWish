...
# Happy Birthday Love
'''
https://patorjk.com/software/taag/#p=display&f=Crawford2&t=Happy%20Birthday%0A%20%20%20%20%20Darianny
   ...
   ✺          \ \__.'   _.-'       Y       `-._    '.__//                          \ \__.'   _.-'       Y       `-._    '.__//
       ...
       ❤                     [""]          .-/|                  \ /                  |\-.          [""]                   ❤             
                   ❤         |  |          ||||      To Dary      |                   ||||          |  |                                    
                             |  |          ||||                   |       ~~*~~       ||||          |  |
                             |  |          ||||    --==*==--      |                   ||||          |  |               ★               
                    :       .'--`.         |||| Have a happy day  |   Don't forget to ||||         .'--`.        :
   ❤              : .:     /`.__.'\        |||| and make sure to  |       smile       ||||        /`.__.'\     : .:
                 :    .   /        \       |||| eat lots of cake! |     --==*==--     ||||       /        \   :    .                   *
           (    ,-'``'-. ;          ;      |||| -------❤️------    |   Love you sweet  ||||      ;          ; ,-'``'-.    (
           )\   |`-..-'| |   ,--.   |      ||||                   |      girl :)      ||||      |   ,--.   | |`-..-'|    )\\                    ❤
          /  )  | .   :| |_.','`.`._|      ||||                   |                   ||||      |_.','`.`._| | .   :|   /  )
